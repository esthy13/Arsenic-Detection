...
5. Does the implementation of the Genetic Algorithm corresponds with what is described in the paper? (explanation with code snippets for the report)

TODO Future tasks:
- Confusion matrix to test the chlorine prediction?
